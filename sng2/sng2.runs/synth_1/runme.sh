...
HD_PWD='C:/Xilinx/VivadoProjects/sng2/sng2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stochastic_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stochastic_multiplier.tcl
