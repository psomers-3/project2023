...
HD_PWD='C:/Xilinx/VivadoProjects/uart_platform/uart_platform.runs/uart_platform_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_platform_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_platform_xbar_0.tcl
