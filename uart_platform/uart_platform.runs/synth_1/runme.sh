...
HD_PWD='C:/Xilinx/VivadoProjects/uart_platform/uart_platform.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_platform_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_platform_wrapper.tcl
