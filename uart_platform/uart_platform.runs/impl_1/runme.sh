...
HD_PWD='C:/Xilinx/VivadoProjects/uart_platform/uart_platform.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_platform_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_platform_wrapper.tcl -notrace
